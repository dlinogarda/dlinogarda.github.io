...
% 			\textcolor{white}{\textbf{Panda}}, % center bubble	
			...
			\textcolor{black!90}{\Large 5},
			\textcolor{black!90}{Citations}\\
			\textcolor{black!90}{112},
			\textcolor{black!90}{RG Score}\\
			\textcolor{black!90}{88.8},
			\textcolor{black!90}{Publications}\\
			\textcolor{black!90}{23}
...
\cvsignature
% --- QR Code for the Last Page ---
% {2.5cm} is the width of the block
% (17cm, 25.5cm) are the X and Y coordinates from the top-left corner
\begin{textblock*}{2.5cm}(17.55cm,25cm) % Adjusted height to 24.5cm to account for text
	\centering
	\href{https://brin.go.id/orei/en/pusat-riset-geoinformatika/page/lino-garda-denaro-st-ms-phd}{\Large\textbf{SCAN ME\\BRIN}}\\[0.2cm] % This adds the text and a 0.2cm gap; Changed \small to \Large for bigger text
	\href{https://brin.go.id/orei/en/pusat-riset-geoinformatika/page/lino-garda-denaro-st-ms-phd}{\includegraphics[width=2.5cm]{BRINQRcode.png}}
\end{textblock*}
\begin{textblock*}{2.5cm}(14.55cm,25cm) % Adjusted height to 24.5cm to account for text
	\centering
	\href{https://dlinogarda.github.io/}{\Large\textbf{SCAN ME\\Website}}\\[0.2cm] % This adds the text and a 0.2cm gap; Changed \small to \Large for bigger text
	\href{https://dlinogarda.github.io/}{\includegraphics[width=2.5cm]{dlinogardaQRCode.png}}
\end{textblock*}
\end{document} 
