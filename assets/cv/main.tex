...
\begin{textblock*}{2.5cm}(17cm,25cm) % Adjusted height to 24.5cm to account for text
	\centering
	{\Large\textbf{BRIN Profile}}\\[0.2cm] % This adds the text and a 0.2cm gap; Changed \small to \Large for bigger text
	\includegraphics[width=2.5cm]{BRINQRcode.png}
\end{textblock*}
